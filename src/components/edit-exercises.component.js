...
export default class EditExercises extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://localhost:5000/exercises/'+this.props.match.params.id) //pegando o id do exercício da url atual
            .then(res => {
                this.setState({
            ...
            .catch(err => console.log("errinho: "+err))
    ...
    onSubmit (e) {
        ...
        axios.post('http://localhost:5000/exercises/update/'+this.props.match.params.id, exercise) //enviando uma requisição de POST com o exercício para ser adicionado ao banco
            .then(res => console.log(res.data)) // printará no console do navegador as informações da resposta da requisição
            .catch(err => console.log('erro do post: '+this.props.match.params.id))
    ...
    render() {
        return (
            <div>
                <h3>Editar entrada de Exercício</h3>
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Editar entrada de Exercício" className="bt btn-primary" />
                    </div>
                </form>
            </div>
        )
